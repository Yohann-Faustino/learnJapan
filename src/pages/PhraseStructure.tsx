...
import styles from "./PhraseStructure.module.css";

export default function PhraseStructurePage() {
  return (
    <div className={styles.parchemin}>
      <h1 className={styles.title}>Structure des phrases japonaises</h1>
        ...
        <div className={styles.content}>
          ...
          <div className={styles.pronunciation}>
            <ul>
              ...
              <li>
                <strong>Pas de pluriel</strong> - watashi peut être "je" ou
                "nous" selon contexte
              </li>
              <li>
              ...
              <li>
                <strong>Masu/Masen</strong> - terminaisons pour
                affirmatif/négatif poli
              </li>
              <li>
          ...
          <div className={styles.pronunciation}>
            <p>
              <strong>La particule wa</strong> s'écrit avec le caractère "ha"
              (は) mais se prononce "wa".
              <br />
              Ex: 私は (watashi wa) → Ne dites PAS "watashi ha" !
            </p>
            <p>
              <strong>La particule e</strong> s'écrit avec le caractère "he"
              (へ) mais se prononce "e" pour la direction.
              <br />
